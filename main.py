...
def main(params, start_week, T=26):
    ...
    for sc in supply_center_set:
        ...
        sub_data = {
            ...
            "isolated_factory_set": model_params_cls.isolated_factory_set[sc]  # NOT utilized now
        }

        model = MPSModel(env, sc, sub_data, params=params)
        model.solve()
...
if __name__ == "__main__":
    ...
    solver_params = {'TimeLimit': 300}
    main(params=solver_params, start_week=start_week)
